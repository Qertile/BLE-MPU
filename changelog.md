...
### New
- add static and inline for functions in hm11.c
- add description for functions in hm11.h


-----------------------------------
## BT-Gyro v2.3.2 (2023.07.14) @master
### New
- release into SF2


-----------------------------------
## BT-Gyro v2.3.1 (2023.07.13) @master
### Changed
- set `Hm11_Packet()`, `Hm11_Config_By_Cmd`, `Hm11_reset`, and `Delay` as static functions
- set `Delay` as a inline function


-----------------------------------
## BT-Gyro v2.3.0 (2023.07.13) @master
### New
- add delay before and after reset to send reset commands
...
-----------------------------------
## BT-Gyro v2.2.1 (2023.07.13) @master
### New
